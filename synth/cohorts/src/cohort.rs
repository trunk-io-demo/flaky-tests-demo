//! Dated cohorts. Retirement is derivable from the name and nothing else:
//!
...
//!
//! Tracked separately, an unplanned gap in the schedule would be indistinguishable
//! from an intentional retirement — and GitHub drops scheduled runs.
